  ...
  return (
    <section id="home-love-support" className="relative mx-auto flex min-h-0 w-full max-w-[260px] flex-1 flex-col px-3 text-center overflow-visible">
      <div className="love-center-area relative flex min-h-0 flex-1 items-center justify-center">
        <div className="pointer-events-none absolute inset-x-0 bottom-1/2 h-56 translate-y-[60px] overflow-visible" aria-hidden="true">
      ...
      <style jsx>{`
        ...
        @keyframes m1 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) scale(.84);opacity:0} 14%{opacity:1} 50%{transform:translate3d(calc(-50% + var(--curve-x)),calc(var(--float-y)*-.48),0) scale(1.04)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)),calc(var(--float-y)*-1),0) scale(.92);opacity:0} }
        @keyframes m2 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) rotate(var(--rotate-start));opacity:0} 12%{opacity:1} 46%{transform:translate3d(calc(-50% + var(--drift-x)*.18),calc(var(--float-y)*-.63),0) rotate(var(--rotate-mid))} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*1.08),calc(var(--float-y)*-.94),0) rotate(var(--rotate-end));opacity:0} }
        @keyframes m3 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) scale(.82);opacity:0} 14%{opacity:1} 34%{transform:translate3d(calc(-50% + var(--drift-x)*.48),calc(var(--float-y)*-.28),0)} 66%{transform:translate3d(calc(-50% + var(--curve-x)*1.2),calc(var(--float-y)*-.72),0)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*.9),calc(var(--float-y)*-1.04),0);opacity:0} }
        @keyframes m4 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) scale(.7);opacity:0} 10%{transform:translate3d(calc(-50% + var(--curve-x)*.35),calc(var(--float-y)*-.2),0) scale(1.14);opacity:1} 58%{transform:translate3d(calc(-50% + var(--drift-x)*.52),calc(var(--float-y)*-.62),0) scale(1)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*1.08),calc(var(--float-y)*-.95),0) scale(.86);opacity:0} }
        @keyframes m5 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) rotate(var(--rotate-start));opacity:0} 14%{opacity:1} 38%{transform:translate3d(calc(-50% + var(--curve-x)*1.25),calc(var(--float-y)*-.32),0) rotate(16deg)} 70%{transform:translate3d(calc(-50% + var(--drift-x)*.32),calc(var(--float-y)*-.72),0) rotate(-14deg)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)),calc(var(--float-y)*-1),0) rotate(var(--rotate-end));opacity:0} }
        @keyframes m6 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0);opacity:0} 12%{opacity:1} 44%{transform:translate3d(calc(-50% + var(--drift-x)*.78),calc(var(--float-y)*-.35),0)} 72%{transform:translate3d(calc(-50% + var(--curve-x)*.5),calc(var(--float-y)*-.75),0)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*1.02),calc(var(--float-y)*-1),0);opacity:0} }
        @keyframes m7 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) scale(.9);opacity:0} 12%{opacity:1} 52%{transform:translate3d(calc(-50% + var(--drift-x)*.34),calc(var(--float-y)*-.52),0) scale(1.08)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*.72),calc(var(--float-y)*-1.12),0) scale(.88);opacity:0} }
        @keyframes m8 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0);opacity:0} 14%{opacity:1} 33%{transform:translate3d(calc(-50% + var(--curve-x)*1.1),calc(var(--float-y)*-.25),0)} 60%{transform:translate3d(calc(-50% + var(--drift-x)*.55),calc(var(--float-y)*-.62),0)} 82%{transform:translate3d(calc(-50% + var(--curve-x)*.25),calc(var(--float-y)*-.82),0);opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)),calc(var(--float-y)*-1),0);opacity:0} }
        @keyframes m9 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) rotate(-10deg);opacity:0} 12%{opacity:1} 45%{transform:translate3d(calc(-50% + var(--drift-x)*.22),calc(var(--float-y)*-.58),0) rotate(14deg)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*1.15),calc(var(--float-y)*-.9),0) rotate(var(--rotate-end));opacity:0} }
        @keyframes m10 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) scale(.76);opacity:0} 9%{transform:translate3d(calc(-50% + var(--start-x)),calc(var(--float-y)*-.16),0) scale(1.12);opacity:1} 48%{transform:translate3d(calc(-50% + var(--curve-x)),calc(var(--float-y)*-.55),0) scale(.98)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*.8),calc(var(--float-y)*-1.06),0) scale(.9);opacity:0} }
        @keyframes m11 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0);opacity:0} 14%{opacity:1} 42%{transform:translate3d(calc(-50% + var(--drift-x)*.62),calc(var(--float-y)*-.4),0)} 64%{transform:translate3d(calc(-50% + var(--drift-x)*.18),calc(var(--float-y)*-.68),0)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*1.1),calc(var(--float-y)*-1),0);opacity:0} }
        @keyframes m12 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) rotate(var(--rotate-start));opacity:0} 12%{opacity:1} 35%{transform:translate3d(calc(-50% + var(--curve-x)*.65),calc(var(--float-y)*-.3),0) rotate(-18deg)} 65%{transform:translate3d(calc(-50% + var(--drift-x)*.72),calc(var(--float-y)*-.7),0) rotate(18deg)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)),calc(var(--float-y)*-1),0) rotate(var(--rotate-end));opacity:0} }
        @keyframes m13 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) scale(.88);opacity:0} 14%{opacity:1} 58%{transform:translate3d(calc(-50% + var(--drift-x)*.5),calc(var(--float-y)*-.72),0) scale(1.02)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*1.25),calc(var(--float-y)*-.88),0) scale(.86);opacity:0} }
        @keyframes m14 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0);opacity:0} 12%{opacity:1} 30%{transform:translate3d(calc(-50% + var(--curve-x)*1.25),calc(var(--float-y)*-.22),0)} 50%{transform:translate3d(calc(-50% + var(--drift-x)*.2),calc(var(--float-y)*-.5),0)} 74%{transform:translate3d(calc(-50% + var(--curve-x)*.55),calc(var(--float-y)*-.78),0)} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*.9),calc(var(--float-y)*-1.05),0);opacity:0} }
        @keyframes m15 { 0%{transform:translate3d(calc(-50% + var(--start-x)),var(--start-y),0) scale(.8) rotate(var(--rotate-start));opacity:0} 12%{opacity:1} 40%{transform:translate3d(calc(-50% + var(--drift-x)*.35),calc(var(--float-y)*-.42),0) scale(1.08) rotate(var(--rotate-mid))} 72%{transform:translate3d(calc(-50% + var(--curve-x)*.9),calc(var(--float-y)*-.78),0) scale(.98) rotate(calc(var(--rotate-mid)*-1))} 84%{opacity:1} 100%{transform:translate3d(calc(-50% + var(--drift-x)*1.05),calc(var(--float-y)*-1),0) scale(.88) rotate(var(--rotate-end));opacity:0} }
        ...
        @media (prefers-reduced-motion: reduce) { .floating-love-event { animation-duration: 900ms; } }
      `}</style>
