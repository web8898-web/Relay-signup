      ...
      <div className="flex-1 px-6 py-5 flex flex-col gap-5 overflow-y-auto">
        ...
        <Field label="分類（自訂，選填）">
          <div className="flex gap-2">
            ...
            />
            <button onClick={addCategory} className="px-4 rounded-2xl bg-white border-2 border-emerald-500 text-emerald-500 text-sm font-semibold hover:bg-emerald-50 transition shrink-0">新增</button>
          </div>
